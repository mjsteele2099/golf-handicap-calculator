...
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('DATABASE_URL', 'sqlite:///golf_handicap.db')
...
def backup_database():
    """Create a backup of the database - not needed for PostgreSQL/Supabase"""
    return jsonify({'message': 'Backup handled by Supabase automatically'})
